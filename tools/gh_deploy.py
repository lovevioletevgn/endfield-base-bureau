...
用法：
    python tools/gh_deploy.py --token <ghp_...> [--dry-run]

安全：
    token 只从命令行参数读取，不落盘、不写日志。
"""
import os, sys, json, base64, time, ssl, argparse, subprocess, urllib.request, urllib.error

ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
GIT = r'C:/Users/Violet Evergarden/.workbuddy/binaries/PortableGit/versions/1.2.0/cmd/git.exe'
OWNER = '1595745135'
