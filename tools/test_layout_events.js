...
// 作者 2026-09-23 实测：手里拿着散布机时点选气条色块 → 又摆了一座（mousedown 冒泡进画布
...
// 作者 2026-09-23：「游戏里是从红圈里开始拉」——按在机器朝外的输出口格上，
...
// ---------- v109 口上「点击=拉线 / 拖动=移机器」待决态（作者：「点机器口机器会被拖动」）----------
...
// ---------- v109 第二半：协议核心出货箭头（作者：「出货口可以点击选择物品出货」+「内部给个箭头」）----------
// 箭头 .lo-dlv 是画布内的可点浮层，空手点击必须放行给选货。⭐v123（作者「手拿传送带
// 一移到口上就只能选货」）：手拿**物流件**时不再放行 —— 新分流：拿件点口=待决态
// （原地松手=拉线、拖动=移动），空手点口=选货浮层；click 链由 LdlvOpen 的
// 「手里有东西不开」守卫兜底。⭐v124（作者「把选择物品的模块移到里面」）：箭头内移一格、
